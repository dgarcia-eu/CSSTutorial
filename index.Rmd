...
.pull-right[
- Analysis of Twitter response to Vienna terrorist attack of November 2nd, 2002
...
- List of original tweets that contain “EAT-Lancet” (or similar) or “yes2meat” from Twitter search interface (Dec 2018 - April 2019):
  - 7281 EAT-Lancet tweets, 8586 ye2smeat tweets, 347 tweets mention both
...
## Disclosure tendency effect

```{r, echo=FALSE, out.width=1100, fig.align='center'}
knitr::include_graphics("figures/alters2.png")
```

- Simulated disclosure: Prediction error decreases with disclosure tendency
